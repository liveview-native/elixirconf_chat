  ...
  def render(%{sidebar: false} = assigns) do
    ...
    <div>
      ...
      <%= if assigns[:show_display_users_modal] and assigns[:count] > 0 do %>
        <div
          class="absolute left-0 top-0 w-full h-full py-4 px-8 bg-white overflow-y-scroll rounded-[32px] outline-none focus-visible:ring-2 focus-visible:ring-brand-purple"
        ...
        >
          ...
          <h3 class="mb-4 font-medium text-xl">Room Participants</h3>
          <ol>
